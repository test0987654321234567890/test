var token;
            var apptype = 0;
            var tasiro="";
            var tasiroUni=`<p><span id="err2">0</span> </p>
            <p>token:<input type="text" id="tok" size="20" value=""></p>
            <button type="button" onclick=tRun() >連投開始</button>
            <section>
            <p>前につける文字列<input type="text" id="1str" size="20" value=""></p>
            <p>　　　　+</p>
            <p>ユニコ<input type="text" id="uni" size="20" value="͢"><button type="button" onclick=uniPad() >ユニコ一覧</button></p>
            <p>重ねる回数<input type="number" id="xint" size="5" value="10000"></p>
            <p>　　　　+</p>
            <p>後につける文字列<input type="text" id="2str" size="20" value=""></p>
            <div id="uniPad"></div>
            </section>`;
        ...
        <h3>ユニコ自動連投:</h3>
        <p>まずユニコ[] に連投したいユニコを入力してください。「ユニコ一覧」を押すと下にユニコの一覧が出ます。ユニコを押すと入力できます。<br>次に前につける文字と後につける文字を入力してください。ユニコの前と後にこの文字が表示されます。<br>重ねる回数は文字数の合計が10000文字を超えないように設定してください。現在の文字数は文字数チェックを押すと表示できます。<br>
文字数チェックで10000文字以下にすると「連投開始」が表示されます。押すと上の[]回で設定した回数[]ミリ秒で連投されます。連投を停止したいときは連投停止を押すと止まります。<br>単品で投下するときは「ユニコ手動投下」を押してください。「改行砲」を押すと改行砲が打てます。</p>
        ...
        <h3>多重連投:</h3>
        <p>token:[]に投下する垢のtokenを入力してください。ユニコを設定して「連投開始」を押して連投出来ます。</p>
        <h2>～よくある質問～</h2>
...
[{"type": "flex","altText":"あいうえお","contents":{
    ...
    "body": {
        ...
        <div id="uniPad"></div>
            ...
            function url() {
                saveApp();
                button1.innerHTML = `<button type="button" onclick= url() id="RED" >通報リンク変換</button><button type="button" onclick= uni()>ユニコ自動連投</button><button type="button" onclick= flex()>Flexメッセージ生成</button><button type="button" onclick= tUni()>多重連投</button><button type="button" onclick= help()>使い方/ヘルプ</button>`;
            ...
            function uni() {
                saveApp();
                button1.innerHTML = `<button type="button" onclick= url()>通報リンク変換</button><button type="button" onclick= uni() id="RED">ユニコ自動連投</button><button type="button" onclick= flex()>Flexメッセージ生成</button><button type="button" onclick= tUni()>多重連投</button><button type="button" onclick= help()>使い方/ヘルプ</button>`;
            ...
            function flex() {
                saveApp();
                button1.innerHTML = `<button type="button" onclick= url()>通報リンク変換</button><button type="button" onclick= uni()>ユニコ自動連投</button><button type="button" onclick= flex() id="RED">Flexメッセージ生成</button><button type="button" onclick= tUni()>多重連投</button><button type="button" onclick= help()>使い方/ヘルプ</button>`;
            ...
            function help() {
                ...
                apptype=0;
                button1.innerHTML = `<button type="button" onclick= url()>通報リンク変換</button><button type="button" onclick= uni()>ユニコ自動連投</button><button type="button" onclick= flex()>Flexメッセージ生成</button><button type="button" onclick= tUni()>多重連投</button><button type="button" onclick= help() id="RED" >使い方/ヘルプ</button>`;
            }
            function tUni(){
                saveApp();
                button1.innerHTML = `<button type="button" onclick= url()>通報リンク変換</button><button type="button" onclick= uni()>ユニコ自動連投</button><button type="button" onclick= flex() >Flexメッセージ生成</button><button type="button" onclick= tUni() id="RED">多重連投</button><button type="button" onclick= help()>使い方/ヘルプ</button>`;
                app.innerHTML = tasiroUni;
                apptype=4;
                setApp();
                document.getElementById('err2').innerHTML = tasiro;
            }
            function saveApp(){
                if (apptype==1){
        ...
        function tRun(){
            ...
            var aft = document.getElementById("2str").value;
            var x = document.getElementById("xint").value;
            var tk=document.getElementById("tok").value;
            var xx = 10000000;
            var rate = 700;
            tr=true;
            tasiro=tasiro+"<br>"+tk;
        ...
        function delC(){
            Cookies.remove('isAgree');Cookies.remove('uni');Cookies.remove('1str');Cookies.remove('2str');Cookies.remove('xint');Cookies.remove('xxint');Cookies.remove('rate');Cookies.remove('OCurl');Cookies.remove('flexJson');
        }